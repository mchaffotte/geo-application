...
CREATE TABLE country (id BIGINT NOT NULL, code VARCHAR(6) NOT NULL, name VARCHAR(50) NOT NULL, land_area INTEGER, water_area INTEGER, capital_id BIGINT, region_id BIGINT, PRIMARY KEY(id));ALTER TABLE country ADD CONSTRAINT uk_country_code UNIQUE(code);
